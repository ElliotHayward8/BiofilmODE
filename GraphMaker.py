...
def main():
    ...
    ax1.plot(t_total4, full_sol4[:, 0], 'b', label='No. of susceptibles', linewidth=2)
    ax1.plot(t_total4, full_sol4[:, 1], 'r', label='No. of persisters', linewidth=2)
    ax2.plot(con_t4, con_sol4[:, 0], 'b', label='No. of susceptibles', linewidth=2)
    ax2.plot(con_t4, con_sol4[:, 1], 'r', label='No. of persisters', linewidth=2)
    ...
    ax1.set_ylim(bottom=-10, top=top_y), ax2.set_ylim(bottom=-10, top=top_y)
    ax1.set_xlim(left=0, right=880), ax2.set_xlim(left=0, right=1125)
    ax1.legend(loc=1, prop=leg_properties), ax2.legend(loc=1, prop=leg_properties)
